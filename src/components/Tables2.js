...
import { faAngleDown, faAngleUp, faArrowDown, faArrowUp, faEllipsisH, faExternalLinkAlt, faEye, faTrashAlt } from '@fortawesome/free-solid-svg-icons';
...
export const PageVisitsTable = () => {
  const TableRow = (props) => {
    const { id, firstName, lastName, rates } = props;
    const bounceIcon = rates < 0 ? faArrowDown : faArrowUp;
    const bounceTxtColor = rates < 0 ? "text-danger" : "text-success";
      ...
      <Card.Header>
        <Row className="align-items-center">
          ...
          <Col className="text-end">
            ...
            <Card.Link as={Link} to={Routs.Staff.path} >
...
export const TransactionsTable = () => {
  ...
  const TableRow = (props) => {
    const { StaffName, ServiceBooked, BookedDate, StartDate, EndDate, price, status } = props;
