...
import IkImage from "../../assets/img/team/ik.jpg"
...
export default ({
  heading = "Meet the brains behind reservely.",
  subheading = "Our Team",
  description = "",
  cards = [
    {
    ...
    },
    {
      ...
      links: [
        ...
        {
          url: "https://www.linkedin.com/in/ikponwosa-evbuoma-b187a7174",
          icon: LinkedinIcon,
        },
        {
          url: "https://github.com/Ikponwosae",
          icon: GithubIcon,
        },
      ],
    },
