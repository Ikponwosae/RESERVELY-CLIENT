...
const CompleteReg = () => {
  ...
  const activate = async () => {
    ...
    try {
      // setLoading(true);
      const data = await api.get(`/auth/verification/${token}`);
            ...
            >
              <div>
                ...
                <h1 className="text-primary mt-5">
                  ...
                  <span className="fw-bolder">SUCCESSFULLY!</span>
                </h1>
                <Button
                ...
                <p className="lead my-4">
                  You will be redirected in 3 seconds. If you have not been
                  redirected to the login page click to register your business.
                </p>
              </div>
            </Col>
          </Row>
