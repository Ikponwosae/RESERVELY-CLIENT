...
import { Breadcrumb, Button, Row, Col, InputGroup, Form, Dropdown, Modal, Card, Table } from "@themesberg/react-bootstrap";
...
const bizId = jwtDecode(token).business;
...
const EditService =  () => {
  ...
  useEffect(() => {
    const getService = async() => {
      try {
        const data = await axios.get(`${baseUrl}/business/${bizId}/services/${servideId}`)
        console.log(data)
  ...
  const initialValues = {
    ...
    const edit = async (name, duration, price, description) => {
        try {
          const response = await axios.patch(`${baseUrl}/owner/service/${servideId}`,{
    ...
    return (
        ...
        <main className="content">
          ...
          <div className="d-lg-flex justify-content-between flex-wrap flex-md-nowrap align-items-center py-4">
            ...
            <h4>YOUR SERVICES</h4>
            <p className="mb-0">Edit this service you offer your customers</p>
            </div>
            </div>
            ...
            <Form onSubmit={handleSubmit}>
                ...
                <Row className="justify-content-md-center">
                    <Button variant="outline-success" size="lg" type="submit" loading={loading} className="me-1">SAVE</Button>
                </Row>
            </Form>
            )}
            </Formik>
